...
\restrict 0BOR1kB3KXYQ0rNkM0k3RJOXYSU6RFKJsMtEt7aZXE0AgbD6m0OIeh5dcUbbq9A
...
--
-- Name: FUNCTION auto_create_safety_label(); Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON FUNCTION public.auto_create_safety_label() IS 'Inserts a fail-closed "sensitive" safety label on every new product so untriaged items are hidden by default until classified.';
...
--
-- Name: TABLE product_safety_labels; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.product_safety_labels IS 'Trust & Safety classification per product. Filter `effective_label=safe` in Swypik general; only `effective_label=adult` shown on Swypik 18+ to verified users.';
...
--
-- Name: TABLE video_safety_labels; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.video_safety_labels IS '4-level safety classification for videos; mirrors product_safety_labels.';
...
--
-- Name: MATERIALIZED VIEW video_rank_14d; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON MATERIALIZED VIEW public.video_rank_14d IS 'Pre-aggregated 14d engagement rank per video. Refresh CONCURRENTLY via /api/cron/refresh-rank.';
...
\unrestrict 0BOR1kB3KXYQ0rNkM0k3RJOXYSU6RFKJsMtEt7aZXE0AgbD6m0OIeh5dcUbbq9A
