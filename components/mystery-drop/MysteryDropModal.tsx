...
import { Sparkles, Gift, Share2, Check, X, ArrowRight, Zap } from "lucide-react";
...
export function MysteryDropModal() {
  ...
  return (
    <>
      {/* Floating Pill Button to Reopen or View Drop */}
      <button
        type="button"
        onClick={() => setIsOpen(true)}
        className="fixed bottom-20 right-4 z-40 flex items-center gap-2 px-3.5 py-2 rounded-full bg-gradient-to-r from-amber-500 via-orange-500 to-pink-500 text-white font-black text-xs shadow-xl hover:scale-105 active:scale-95 transition-all animate-bounce"
      >
