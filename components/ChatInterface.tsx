      ...
      {activeTab === "home" && (
        <div className="px-4 pt-6">
          <div className="rounded-2xl border border-[#E5E5E5] bg-[#F7F7F8] p-6">
            <h2 className="text-3xl font-black leading-tight tracking-tight text-[#0D0D0D]">Caută orice produs.<br/>AI-ul îți face și bundle.</h2>
            <p className="mt-2 text-sm font-medium text-[#6E6E80]">Search instant în 108.000+ produse. Zero limite.</p>
            <div className="relative">
              <div className={`mt-4 flex items-center gap-2 rounded-xl p-3 ${THEME.classes.softInput}`}>
                ...
                <input value={input} onChange={(e) => setInput(e.target.value)} onKeyDown={(e) => { if (e.key === "Enter") runRealSearch(input); }} className="w-full bg-transparent text-sm font-medium text-[#0D0D0D] outline-none placeholder:text-[#A1A1AA]" placeholder="Ex: rochie, cadou, sub 100 lei..." />
              </div>
