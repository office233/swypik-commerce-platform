...
export default function ChatInterface({ 
  ...
  async function sendMessage(text?: string) {
    ...
    } catch (error: any) { setMessages((prev) => [...prev, { id: crypto.randomUUID(), role: "assistant", content: error?.message || t("errGenericaAparut"), timestamp: new Date() }]); } finally { setIsLoading(false); }
  }
