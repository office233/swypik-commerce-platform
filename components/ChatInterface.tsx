      ...
      {activeTab === "home" && (
        <div className="px-4 pt-6">
          <div className="rounded-2xl border border-[#E5E5E5] bg-[#F7F7F8] p-6">
            ...
            <p className="mt-2 text-sm font-medium text-[#6E6E80]">Caută instant în mii de produse cu livrare în România.</p>
          ...
          <div className="mt-3 flex flex-wrap gap-2">
            {QUICK_ACTIONS.map((qa) => <button key={qa.label} onClick={() => runRealSearch(qa.query)} className="rounded-full bg-white border border-[#E5E5E5] px-3.5 py-2 text-xs font-bold text-[#0D0D0D] hover:border-[#10A37F] hover:text-[#10A37F] active:scale-95 transition-all">{qa.label}</button>)}
          </div>
          <div className="mt-4">
