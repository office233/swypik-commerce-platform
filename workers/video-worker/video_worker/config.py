...
class Settings:
    ...
    def from_env(cls, env: Mapping[str, str] | None = None) -> "Settings":
        ...
        public_base_url = _optional(values, "S3_PUBLIC_BASE_URL", "R2_PUBLIC_BASE_URL")
        if public_base_url:
