      ...
      <div className="flex-1 relative">
        ...
        {pinned && (
          <div className="absolute bottom-4 left-4 right-4 bg-white text-black rounded-xl p-3 flex items-center gap-3 shadow-lg">
            ...
            <Link href={`/product/${pinned.product_id}`} className="inline-flex items-center justify-center bg-violet-600 hover:bg-violet-700 text-white px-5 py-3 min-h-[44px] rounded-lg text-sm font-semibold focus-visible:ring-2 focus-visible:ring-white/40 focus-visible:outline-none">{t("cumpara")}</Link>
          </div>
        )}
        {items.length > 1 && (
