...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  if (!page) return { title: "Pagină negăsită — Swypik" };
  return {
    title: page.title,
      ...
      <div className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mt-8 space-y-3">
          ...
          <details className="rounded-xl border border-[#E5E5E5] bg-white p-4">
            ...
            <p className="mt-2 text-sm text-[#6E6E80]">Da, toate produsele listate pe Swypik au livrare disponibilă în România, cu un timp estimat de 5-15 zile lucrătoare.</p>
          </details>
          <details className="rounded-xl border border-[#E5E5E5] bg-white p-4">
