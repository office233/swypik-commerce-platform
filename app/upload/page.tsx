  ...
  return (
    <main className="min-h-[calc(100vh-4rem)] bg-gradient-to-b from-white to-[#FAFAFA] dark:from-black dark:to-[#0A0A0A] px-5 pt-10 pb-28">
      <div className="mx-auto max-w-md">
        <div className="flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-[#7C3AED] to-[#EC4899] shadow-lg mb-6">
        ...
        <p className="text-[15px] text-[#6E6E80] dark:text-[#A1A1AA] leading-relaxed mb-8">
          Postează clipuri video cu produsele tale preferate, construiește o comunitate și câștigă comisioane la fiecare vânzare.
        </p>
        ...
        <ul className="space-y-4 mb-10">
          ...
          <li className="flex gap-3 items-start">
            <span className="flex-shrink-0 mt-0.5 w-9 h-9 rounded-xl bg-[#F4F4F5] dark:bg-[#1F1F1F] flex items-center justify-center">
              <DollarSign size={18} className="text-[#EC4899]" />
            </span>
            <div>
        ...
        <Link
          ...
          className="flex items-center justify-center w-full h-12 rounded-2xl bg-gradient-to-r from-[#7C3AED] to-[#EC4899] text-white font-semibold text-[15px] shadow-md active:scale-[0.98] transition-transform"
        >
