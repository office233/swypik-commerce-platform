 ...
 * Aprobă o aplicație de comerciant local: status 'pending' → 'active'.
 * Comerciantul devine imediat vizibil în Food.
 */
...
export async function POST(
  ...
  try {
    ...
    logger.error({ err: error, id }, "[admin/merchants/approve] error");
